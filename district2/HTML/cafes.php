...
<body>
    ...
    <div class="card-group">
      <div class="card" style="width: 20rem;">
        <img src="assets/img/images_the_district/catégorie/café/café.png" class="card-img-top" alt="café">
        <div class="card-body">
      ...
      <div class="card" style="width: 20rem;">
        <img src="assets/img/images_the_district/catégorie/café/cafeaulait.png" class="card-img-top" alt="caféaulait">
        <div class="card-body">
      ...
      <div class="card" style="width: 20rem;">
        <img src="assets/img/images_the_district/catégorie/café/cafelatte.png" class="card-img-top" alt="cafélatte">
        <div class="card-body">
      ...
      <div class="card" style="width: 20rem;">
        <img src="assets/img/images_the_district/catégorie/café/cafecreme.png" class="card-img-top" alt="cafécreme">
        <div class="card-body">
      ...
      <div class="card" style="width: 20rem;">
        <img src="assets/img/images_the_district/catégorie/café/cafecourt.png" class="card-img-top" alt="cafécourt">
        <div class="card-body">
