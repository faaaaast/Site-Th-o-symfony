...
<body>
    ...
    <div class="card-group">
        <div class="card" style="width: 20rem;">
            <img src="assets/img/images_the_district/catégorie/calzone.png" class="card-img-top" alt="pizza-calzone">
            <div class="card-body">
        ...
        <div class="card" style="width: 20rem;">
            <img src="assets/img/images_the_district/catégorie/chevremiel.png" class="card-img-top" alt="pizza-chevre-miel">
            <div class="card-body">
        ...
        <div class="card" style="width: 20rem;">
            <img src="assets/img/images_the_district/catégorie/thon.png" class="card-img-top" alt="pizza-thon">
            <div class="card-body">
        ...
        <div class="card" style="width: 20rem;">
            <img src="assets/img/images_the_district/catégorie/3fromages.png" class="card-img-top" alt="pizza-3-formages">
            <div class="card-body">
        ...
        <div class="card" style="width: 20rem;">
            <img src="assets/img/images_the_district/catégorie/saumon.png" class="card-img-top" alt="pizza-saumon">
            <div class="card-body">
